...
type: session
source: claude-code
uuid: e2f51491-0c87-4cf0-86a3-28dde614eee9
title: "Create system architecture diagram"
project: "[[charlie]]"
cwd: "/Users/andrewshipley/Desktop/Poesis/Andrew/AI Agents/Charlie/charlie"
created: 2026-05-31
updated: 2026-05-31
message_count: 8
status: stub
...
run yolo on this session. permissions disabled, dangerously permissioned whatever
...
enable dangerously skip permissions / allow all tools without prompting

**assistant**

Reading the project settings file first.

**assistant**

Done. `defaultMode` is now set to `bypassPermissions` in the project settings — all tool calls will proceed without prompting for the rest of this session (and future ones in this project). Now, back to that architecture diagram — let me explore the codebase.

**assistant**

Now I have enough to draw the diagram.
...
╔═══════════════════════╗     ╔═══════════════════════════════════════════╗
║   ENTRY POINTS        ║     ║   EXTERNAL SERVICES                       ║
╠═══════════════════════╣     ╠═══════════════════════════════════════════╣
║                       ║     ║                                           ║
║  web.py (Flask)       ║     ║  Anthropic Claude API                     ║
║  ├─ Browser UI        ║     ║  ├─ claude-sonnet-4-6   (daily tasks)     ║
║  └─ REST API          ║     ║  └─ claude-opus-4-6     (deep/thesis)     ║
║                       ║     ║                                           ║
║  orchestrator.py      ║     ║  Web Search (Claude tool)                 ║
║  └─ CLI / Scheduled   ║     ║  └─ ingestion web search passes           ║
╚═══════════╤═══════════╝     ╚═══════════════════════════════════════════╝
            │                              ▲
            ▼                              │
╔═══════════════════════════════════════════════════════════════════════╗
...
║                                                                       ║
║  DAILY (6am / /run POST)                                              ║
║  Ingestion ──▶ Analysis ──▶ Brief ──▶ Adversary ──▶ Render            ║
║                                                                       ║
║  THESIS (weekly / manual)                                             ║
║  Thesis Synthesis ──▶ Proposal → /thesis/review UI → Publish         ║
║                                                                       ║
║  ON-DEMAND                                                            ║
║  Oven Take (any time via /oven)                                       ║
║  Field Work Upload → Acknowledgment (via /field)                      ║
╚═══════════╤═══════════════════════════════════════════════════════════╝
            │
            ▼
╔═══════════════════════════════════════════════════════════════════════╗
║                         AGENTS (agents/)                              ║
╠═══════════════════╦═══════════════════════════════════════════════════╣
║ ingestion.py      ║ Multi-pass web search → structured signals        ║
║                   ║ Uses web_search tool (3 uses/call)                ║
╠═══════════════════╬═══════════════════════════════════════════════════╣
║ analysis.py       ║ Score & rank signals → findings                   ║
║                   ║ Tags thesis force: supply/demand/discovery        ║
╠═══════════════════╬═══════════════════════════════════════════════════╣
║ brief.py          ║ Findings → 3-tier brief                           ║
║                   ║ Tier 1: The Signal                                ║
║                   ║ Tier 2: The Bullshit Flag                         ║
║                   ║ Tier 3: Your World (+ Field Work injection)       ║
╠═══════════════════╬═══════════════════════════════════════════════════╣
║ adversary.py      ║ Critique the brief                                ║
║                   ║ Finds: flattery / pattern exhaustion /            ║
║                   ║  inference theater / missing story /              ║
║                   ║  comfortable framing                              ║
╠═══════════════════╬═══════════════════════════════════════════════════╣
║ thesis.py         ║ 7-day signals + sessions + Field Work →           ║
║                   ║ Propose extensions / revisions / new patterns     ║
║                   ║ Supports up to 5 refinement iterations            ║
╠═══════════════════╬═══════════════════════════════════════════════════╣
║ oven.py           ║ On-demand strategic take from prompt               ║
║                   ║ Grounded in thesis + recent briefs + Field Work   ║
╠═══════════════════╬═══════════════════════════════════════════════════╣
║ acknowledge.py    ║ Generate acknowledgment for Field Work upload     ║
╠═══════════════════╬═══════════════════════════════════════════════════╣
║ research.py       ║ Ad-hoc deep research                               ║
╚═══════════════════╩═══════════════════════════════════════════════════╝
            │
            ▼
╔═══════════════════════════════════════════════════════════════════════╗
║                         CORE (core/)                                  ║
╠════════════════════╦══════════════════════════════════════════════════╣
║ client.py          ║ call_agent() — Anthropic SDK wrapper             ║
║ config.py          ║ Config singleton (env vars, model names, paths)  ║
║ state.py           ║ StateManager — all JSON file I/O                 ║
║ prompts.py         ║ Prompt builders (brief / thesis / oven)          ║
║ render.py          ║ Markdown / HTML / PDF output                     ║
║ logging.py         ║ Structured logging                               ║
║ field_access.py    ║ Field Work retrieval & citation caps             ║
║ field_extract.py   ║ Artifact content extraction                      ║
╚════════════════════╩══════════════════════════════════════════════════╝
            │
            ▼
╔═══════════════════════════════════════════════════════════════════════╗
...
╠══════════════════════════╦════════════════════════════════════════════╣
║ signals/YYYY-MM-DD.json  ║ Daily extracted signals                    ║
║ briefs/YYYY-MM-DD.json   ║ Daily 3-tier briefs                        ║
║ adversary/YYYY-MM-DD.json║ Daily adversary critique                   ║
║ thesis/current.json      ║ Active thesis (Far Mar)                    ║
║ thesis/proposals/        ║ Pending proposals (iteration state)        ║
║ thesis/history/          ║ Archived thesis versions                   ║
║ sessions.json            ║ Companion responses from user              ║
║ feedback.json            ║ Signal relevance ratings                   ║
║ adversary/feedback.json  ║ Adversary finding responses                ║
║ field/artifacts/         ║ Field Work metadata                        ║
║ field/originals/         ║ Uploaded source files                      ║
║ field/extracted/         ║ Extracted text/content                     ║
║ field/acknowledgments/   ║ Agent-written acknowledgments              ║
║ oven/takes/              ║ Generated strategic takes                  ║
╠══════════════════════════╬════════════════════════════════════════════╣
║ context/profile.json     ║ User profile ("Liz")                       ║
║ context/slate.json       ║ Current working hypotheses                 ║
║ context/watching.json    ║ Entity watchlist                           ║
║ context/sessions.json    ║ Session history                            ║
╚══════════════════════════╩════════════════════════════════════════════╝
...
╠════════════════════╦══════════════════════════════════════════════════╣
║ GET  /             ║ → latest brief                                   ║
║ GET  /brief/<date> ║ View brief (signals + adversary section)         ║
║ GET  /companion    ║ Respond to open questions (feeds sessions.json)  ║
║ GET  /thesis       ║ Current Far Mar thesis                           ║
║ GET  /thesis/review║ Review pending proposal (flag/annotate/publish)  ║
║ GET  /field        ║ Upload & view Field Work artifacts               ║
║ GET  /oven         ║ Generate strategic takes                         ║
║ GET  /archive      ║ Brief history list                               ║
║ GET  /run          ║ Manual pipeline trigger UI                       ║
╠════════════════════╬══════════════════════════════════════════════════╣
║ POST /run          ║ Trigger daily pipeline or thesis synthesis        ║
║ POST /api/feedback ║ Save signal rating (1-10)                        ║
║ POST /api/companion/session    ║ Save tier response                   ║
║ POST /api/adversary/feedback   ║ Rate adversary finding               ║
║ POST /api/thesis/annotate      ║ Flag/annotate proposal items         ║
║ POST /api/thesis/refine        ║ Trigger Opus refinement pass         ║
║ POST /api/thesis/publish|discard ║ Accept or discard proposal         ║
║ POST /api/field/upload         ║ Upload + acknowledge artifact        ║
║ POST /api/oven/take            ║ Generate take                        ║
╚════════════════════╩══════════════════════════════════════════════════╝

DATA FLOW (DAILY):
  Web search → raw text
    └─ ingestion.py ──▶ signals/YYYY-MM-DD.json
         └─ analysis.py ──▶ findings (in-memory)
              └─ brief.py ──▶ briefs/YYYY-MM-DD.json
                   │ (+ field_access retrieval for Tier 3)
                   └─ adversary.py ──▶ adversary/YYYY-MM-DD.json
                        └─ render.py ──▶ .md / .html / .pdf

FEEDBACK LOOP:
  User rates signals ──▶ feedback.json
  User responds in Companion ──▶ sessions.json
  User rates adversary findings ──▶ adversary/feedback.json
